...
export namespace Prisma {
  ...
  */
  ...
  export type DeliverymanCountOutputTypeGetPayload<
    ...
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof DeliverymanCountOutputType ?DeliverymanCountOutputType [P]
  : 
     never
  } 
    : DeliverymanCountOutputType
  ...
  export type ClientsCountOutputTypeGetPayload<
    ...
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof ClientsCountOutputType ?ClientsCountOutputType [P]
  : 
     never
  } 
    : ClientsCountOutputType
  ...
  type GetDeliverymanGroupByPayload<T extends DeliverymanGroupByArgs> = Promise<
    Array<
  ...
  export type DeliverymanGetPayload<
    ...
    [P in TrueKeys<S['include']>]: 
        ...
        ? Array < DeliveriesGetPayload<S['include'][P]>>  :
        P extends '_count'
        ? DeliverymanCountOutputTypeGetPayload<S['include'][P]> : never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof Deliveryman ?Deliveryman [P]
  : 
          P extends 'deliveries'
        ? Array < DeliveriesGetPayload<S['select'][P]>>  :
        P extends '_count'
        ? DeliverymanCountOutputTypeGetPayload<S['select'][P]> : never
  } 
    : Deliveryman
  : Deliveryman
  ...
  export interface DeliverymanDelegate<GlobalRejectSettings> {
    ...
    **/
    ...
    >(args: SubsetIntersection<T, DeliverymanGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetDeliverymanGroupByPayload<T> : Promise<InputErrors>
  }
  ...
  export type ClientsGetPayload<
    ...
    [P in TrueKeys<S['include']>]: 
        ...
        ? Array < DeliveriesGetPayload<S['include'][P]>>  :
        P extends '_count'
        ? ClientsCountOutputTypeGetPayload<S['include'][P]> : never
  } 
    : 'select' extends U
    ? {
  ...
  : 
        ...
        ? Array < DeliveriesGetPayload<S['select'][P]>>  :
        P extends '_count'
        ? ClientsCountOutputTypeGetPayload<S['select'][P]> : never
  } 
    : Clients
  : Clients
  ...
  type GetDeliveriesGroupByPayload<T extends DeliveriesGroupByArgs> = Promise<
    Array<
  ...
  export type DeliveriesGetPayload<
    ...
    [P in TrueKeys<S['include']>]: 
          P extends 'client'
        ? ClientsGetPayload<S['include'][P]> :
        P extends 'deliveryman'
        ? DeliverymanGetPayload<S['include'][P]> | null : never
  } 
    : 'select' extends U
    ? {
  ...
  : 
          P extends 'client'
        ? ClientsGetPayload<S['select'][P]> :
        P extends 'deliveryman'
        ? DeliverymanGetPayload<S['select'][P]> | null : never
  } 
    : Deliveries
  : Deliveries
  ...
  export interface DeliveriesDelegate<GlobalRejectSettings> {
    ...
    **/
    ...
    >(args: SubsetIntersection<T, DeliveriesGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetDeliveriesGroupByPayload<T> : Promise<InputErrors>
  }
